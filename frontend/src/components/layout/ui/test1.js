...
const UserManagementPage = () => {
  ...
  // เปิด modal และโหลดข้อมูลเดิมของผู้ใช้
const openProfileModal = () => {
  setNewEmail(currentUser.email); // ✅ ใช้ค่าปัจจุบันเป็นค่าเริ่มต้น
  setNewName(currentUser.name);
  setNewPassword(""); // ✅ ไม่เติม password เพื่อความปลอดภัย
